...
\begin{itemize}
    ...
    \item Verbesserung des zielgerichteten Marketings durch die Bereitstellung von Herkunftsanalysen
    \item Basis für die GHG (Greenhouse Gas Protocol) Scope 3 Emissionsberechnung des Besucheraufkommens liefern \cite{ghg_scope3}
