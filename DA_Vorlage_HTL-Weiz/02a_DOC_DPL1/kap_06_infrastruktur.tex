...
Docker Compose nutzt, wie bereits im entsprechenden Kapitel erwähnt, YAML-Dateien, welche zur Kennung mit den Endungen \texttt{.prod.yaml} und \texttt{.dev.yaml} versehen wurden.
...
Die Umsetzung dieser Prinzipien erfolgt im Projekt über GitHub Actions, ein in GitHub integriertes Automatisierungstool, mit welchem Workflows zum Bauen, Testen und Bereitstellen von Software direkt im Repository definiert werden können \cite{github_actions}.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{restore_flow.png}
