...
Der konfigurierbare Intervall-Filter, wie in der Implementierung (Abschnitt~\ref{sec:duplikatpruefung}) beschrieben, verhindert, dass ein Fahrzeug, das beispielsweise anhält und erneut anfährt, als separate Erkennung gezählt wird.
