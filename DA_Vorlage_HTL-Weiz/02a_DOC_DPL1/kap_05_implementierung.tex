...
\begin{figure}[htbp]
    ...
    \caption{IP Camera Tool\protect\footnotemark}
...
\begin{figure}[htbp]
    ...
    \caption{Erkennungsbereich im Deep Video Analytics Tool}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{data_collection.png}
    \caption{Data Collection Flow}
...
Die Bilddaten werden als \texttt{BytesIO}-Objekt übergeben, also als im Arbeitsspeicher gehaltener Byte-Stream.
