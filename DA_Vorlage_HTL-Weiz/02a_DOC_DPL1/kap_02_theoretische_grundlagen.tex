...
Die Containerisierung ist eine Methode, bei welcher Anwendungen und deren Abhängigkeiten in einer leichtgewichtigen, isolierten Einheit, einem sogenannten Container, verpackt werden.
...
Docker Compose startet Services in der vordefinierten Reihenfolge und ermöglicht automatische Kommunikation zwischen ihnen. \cite{docker_compose}
...
ALPR (Automatic License Plate Recognition) bezeichnet die automatisierte Erfassung und Auswertung von Fahrzeugkennzeichen aus Bilddaten mittels Computer-Vision und Deep Learning. \cite{platerecognizer_alpr}
...
\label{sec:mmc}
Neben der im Vergleich sehr zuverlässigen Kennzeichenerkennung identifiziert Plate Recognizer zusätzliche Fahrzeugattribute \cite{platerecognizer_mmc}, ein Ansatz, der MMC-Erkennung genannt wird:
\begin{itemize}
...
Die On-Premise-Variante ermöglicht vollständige lokale Ausführung ohne externe Netzwerkabhängigkeit \cite{platerecognizer_snapshot}, eine Anforderung, welche Zotter Schokolade sehr wichtig war.
