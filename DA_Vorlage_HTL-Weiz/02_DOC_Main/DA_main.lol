...
\contentsline {lstlisting}{\numberline {4}{\ignorespaces Volume Mount Entwicklungs-Compose-Konfiguration}}{46}{lstlisting.4}%
\contentsline {lstlisting}{\numberline {5}{\ignorespaces Image Produktions-Compose-Konfiguration}}{47}{lstlisting.5}%
\contentsline {lstlisting}{\numberline {6}{\ignorespaces Startabhängigkeiten Datenbank Prestart}}{47}{lstlisting.6}%
\contentsline {lstlisting}{\numberline {7}{\ignorespaces Auszug Build-Script \texttt {build.sh}}}{49}{lstlisting.7}%
