...
\noindent
\begin{tabular}{@{}p{6cm} p{1cm} p{7cm}@{}}
    Weiz, am \ADatum &  & \dotfill                          \\
                     &  & \makebox[\linewidth]{\DPLNameOne}
\end{tabular}
...
Nicht nur, weil mich persönlich vieles mit diesem Unternehmen verbindet, sondern auch, weil ich die Dynamik des Unternehmens einzigartig finde.
...
Nach einiger Zeit kamen wir auf die Idee, für diesen Zweck die Kennzeichen der Besucherfahrzeuge zu analysieren. An dieser Idee hielten wir fest. \\
...
Meinen Klassenkameraden danke ich für die andauernde Motivation während der tollen 5 Jahre, die ich mit ihnen verbringen durfte.
Abschließend möchte ich meiner Familie danken, die mich mein gesamtes Leben lang bedingungslos unterstützt hat.
...
\DeclareTOCStyleEntry[beforeskip=9pt]{section}{section}
