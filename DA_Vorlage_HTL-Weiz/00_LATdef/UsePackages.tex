...
\usepackage[protrusion=true,expansion=true,final]{microtype} % Better line breaking, prevents overfull hboxes
\setlength{\emergencystretch}{1em} % Fallback: allows slight extra stretch before overflowing
