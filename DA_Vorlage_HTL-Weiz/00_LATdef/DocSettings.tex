...
%		\small{\changefont{pag}{b}{sc}\textcolor{black!60}{\DAName}}
%	\end{tabular} \vspace{0.1cm}}
%\lfoot{\small{\changefont{pag}{b}{sc}\textcolor{black!60}{\SYear - \SClass - \DPLNameOne, \DPLNameTwo}}} 
%\cfoot{}
%\rfoot{\small{\changefont{pag}{b}{sc}\textcolor{black!60}{\thepage\ \textbf{\textcolor{orange!100}I} \pageref{LastPage}}}}
\lhead{\begin{tabular}{p{14.0cm}}
    \small{\sffamily\bfseries\textcolor{black!60}{\DAName}}
  \end{tabular} \vspace{0.1cm}}
\lfoot{\small{\sffamily\bfseries\textcolor{black!60}{\SYear \space-- \SClass  \space-- \DPLNameOne \DPLNameTwo}}}
\cfoot{}
\rfoot{\small{\sffamily\bfseries\textcolor{black!60}{\thepage}}}
%s
\renewcommand{\headrulewidth}{0.4pt}
\renewcommand{\footrulewidth}{0.4pt}
\let\myHeadrule\headrule
\let\myFootrule\footrule
\renewcommand\headrule{\color{black!60}\myHeadrule }
\renewcommand\footrule{\color{black!60}\myFootrule }
